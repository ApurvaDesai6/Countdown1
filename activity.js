...
let addEntry = (bookList, entry) => bookList.push(entry);
let removeBook = (bookList, titleOfBook) => bookList.filter(x => x.title !== titleOfBook)
printList = (bookList) => {
...
addEntry(bookList, {title: "Diary of a Wimpy Kid", author: "Apurva Desai"})
printList(bookList)
